...
cgmaptools mbin -i ${GENOME}.CGmap.gz -C CG -B 100000 -c 1  > ${GENOME}.mCG.mbin.10k.data
cgmaptools mbin -i ${GENOME}.CGmap.gz -C CHG -B 100000 -c 1  > ${GENOME}.mCHG.mbin.10k.data
cgmaptools mbin -i ${GENOME}.CGmap.gz -C CHH -B 100000 -c 1  > ${GENOME}.mCHH.mbin.10k.data
done
