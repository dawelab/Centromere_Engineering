...
#######################################################
echo "samtools view -b -F 4 -S output/ABS/BAM/${i}_ABS.sam -o output/ABS/BAM/${i}_ABS.bam" >> ${out}  
echo "samtools view -b -F 4 -S output/W22/BAM/${i}_W22.sam -o output/W22/BAM/${i}_W22.bam" >> ${out}  
echo "samtools view -b -F 4 -S output/Mo17/BAM/${i}_Mo17.sam -o output/Mo17/BAM/${i}_Mo17.bam" >> ${out}  
...
echo "rm output/ABS/BAM/${i}_ABS.bam output/W22/BAM/${i}_W22.bam output/Mo17/BAM/${i}_Mo17.bam" 
#######################################################
