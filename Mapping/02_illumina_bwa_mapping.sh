...
out=/scratch/yz77862/illumina_neo4Ls/shell/${j}_map.sh
genome=/scratch/yz77862/MaizeGenome/${j}.fa
echo '#!/bin/bash' >> ${out}
echo "#SBATCH --job-name=map_${j}" >> ${out}                  
...
echo "#SBATCH --output=map_${j}.out">> ${out}  			  
echo "#SBATCH --error=map_${j}.err">> ${out}  
echo " " >> ${out}  
...
echo "mkdir -p /scratch/yz77862/illumina_neo4Ls/${j}" >> ${out}  
echo "cd /scratch/yz77862/illumina_neo4Ls/${j}" >> ${out}  
echo "for i in J721 KD4277 KD4289-6 KD4300-7 KD4303-1 KD4303-2 KD4304-1 L6 LexA_CENH3_abs4_S23;do" >> ${out}  
echo "fastq1=/scratch/yz77862/illumina_neo4Ls/${i}_R1_001.fastq.gz.trimmed.fastq.gz" >> ${out}  
echo "fastq2=/scratch/yz77862/illumina_neo4Ls/${i}_R2_001.fastq.gz.trimmed.fastq.gz" >> ${out}  
