...
##use blast to generate the identity files
ml BLAST+
...
blastn -query ptg000174l.fa -db ptg000016l.fa_blastdb -out ptg000174l_blast_ptg000016l_result.xls -task blastn -outfmt 6
